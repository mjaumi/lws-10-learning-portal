...
const AssignmentTableRow = ({ assignmentId, title, videoTitle, marks }) => {
    ...
    // handler function to trigger edit assignment
    const editAssignmentHandler = () => {
        triggerGetAssignment(assignmentId, false);
    }
    ...
    return (
        <tr>
            ...
            <td className='table-td flex gap-x-2 justify-center'>
                ...
                <button onClick={editAssignmentHandler} className='disabled:opacity-80 disabled:cursor-not-allowed' disabled={isEditLoading}>
                    <svg fill='none' viewBox='0 0 24 24' strokeWidth='1.5' stroke='currentColor'
